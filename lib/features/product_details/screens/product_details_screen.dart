...
import 'package:amazon_admin_panel/common/widgets/stars.dart';
import 'package:amazon_admin_panel/constants/global_variable.dart';
import 'package:amazon_admin_panel/features/product_details/services/product_details_services.dart';
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void initState() {
    ...
    for (int i = 0; i < widget.product.rating!.length; i++) {
      totalRating += widget.product.rating![i].raring;
      if (widget.product.rating![i].userId ==
          Provider.of<UserProvider>(context, listen: false).user.id) {
        myRating = widget.product.rating![i].raring;
      }
    }
  }
        ...
        child: Column(
          ...
          children: [
            ...
            RatingBar.builder(
              ...
              onRatingUpdate: (raring) {
                productDetailsServices.rateProduct(
                    context: context, product: widget.product, raring: raring);
              },
            )
          ],
        ),
